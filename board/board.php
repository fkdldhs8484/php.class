    ...
    <main id="main">
        <section id="board" class="container">
            ...
            <div class="board__search">
                ...
                <div class="right">
                    <form action="boardSearch.php" name="boardSearch" method="get"></form>
                    <fieldset>
...
// 1~20 --> 1page : DESC 0, 20  ---> ($ciewNum * 1) - $viewNum
// 21~40 --> 2page  : DESC 20, 20    ---> ($ciewNum * 2) - $viewNum
// 41~60 --> 3page  : DESC 40, 20    ---> ($ciewNum * 3) - $viewNum
// 61~80 --> 4page  : DESC 60, 20    ---> ($ciewNum * 4) - $viewNum
...
?>
                            <!-- <tr>
                                <td>1</td>
                                <td><a href="boardView.html"></a> 게시판 제목입니다.</td>
                                <td>이유나</td>
                                <td>2022-03-04</td>
                                <td>9</td>
                            </tr>
...
for ($i = $startPage; $i <= $endPage; $i++) {
    ...
    echo "<li class='{$active}'><a href='board.php?page={$i}'>{$i}</a></li>"; //클릭하면 주소창 번호 바뀜.
}
