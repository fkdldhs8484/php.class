        ...
        <section id="board" class="container">
            ...
            <div class="board__inner">
                <div class="board__title">
                    <h3>게시판 수정하기</h3>
                    <p>웹디자이너, 웹퍼블리셔, 프론트앤드 개발자를 위한 개시판입니다.</p>
                </div>
...
if ($result) {
    ...
    echo "<div style='display:none'><label for='myBoardID'>번호</label><input type='text' name='myBoardID' id='myBoardID' value='" .
        $info['myBoardID'] .
        "'></div>";
    echo "<div><label for='boardTitle'>제목</label><input type='text' name='boardTitle' id='boardTitle' value='" .
        $info['boardTitle'] .
        "'></div>";
    echo "<div><label for='boardContents'>내용</label><textarea name='boardContents' id='boardContents' rows='20'>" .
        $info['boardContents'] .
        '</textarea></div>';
