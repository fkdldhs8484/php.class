    ...
    if($blogImgType){
        ...
        if($fileType == "image"){
            if($fileExtension == "jpg" || $fileExtension == "jpeg" || $fileExtension == "png" || $fileExtension == "gif"){
                ...
                // echo "이미지 파일이 맞네요!";
                $sql = "INSERT INTO myBlog(myMemberID, blogTitle, blogContents, blogCategory, blagAuthor, blogView, blogLike, blogImgFile, blogImgSize, blogDelete, blogRegTime) VALUES('$myMemberID', '$blogTitle', '$blogContents ', '$blogCategory', '$blogAuthor', '$blogView', '$blogLike', '$blogImgName', '$blogImgSize', '$blogLike', '$regTime' )";
        } else {
        ...
        $sql = "INSERT INTO myBlog(myMemberID, blogTitle, blogContents, blogCategory, blagAuthor, blogView, blogLike, blogImgFile, blogImgSize, blogDelete, blogRegTime) VALUES('$myMemberID', '$blogTitle', '$blogContents ', '$blogCategory', '$blogAuthor', '$blogView', '$blogLike', 'Img_default.jpg', '$blogImgSize', '$blogLike', '$regTime' )" ; 
